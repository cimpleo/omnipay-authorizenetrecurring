...
use Academe\AuthorizeNet\Payment\OpaqueData as AuthorizeNetOpaqueData;

class OpaqueData extends AuthorizeNetOpaqueData
{
    ...
    public function __construct($parameters = null) {
        parent::__construct($parameters['dataDescriptor'], $parameters['dataValue']);
